      ...
      <CardContent className="pt-6">
        {!isConnected ? (
          <div className="text-center py-6">
            ...
            <p className="mt-4 text-sm text-gray-400">برای ساخت توکن، ابتدا کیف پول خود را متصل کنید</p>
          </div>
        ) : !isCorrectNetwork ? (
          <div className="text-center py-6">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Button
                ...
                className="text-xs border-gray-700 text-gray-300 hover:bg-gray-800 flex items-center gap-1"
              >
              ...
              <div className="space-y-2">
                ...
                {tokenSupply && (
                  <div className="flex items-center mt-1 text-xs text-gray-500">
                    ...
                    <span className="text-gray-400">{convertToPersianWords(tokenSupply)}</span>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4 p-4 bg-purple-950/50 rounded-md border border-purple-900/50">
                ...
                <div className="space-y-2">
                  ...
                  {irtAmount && (
                    <div className="flex items-center mt-1 text-xs text-gray-500">
                      ...
                      <span className="mx-1">-</span>
                      <span className="text-gray-400">{convertToPersianWords(irtAmount)}</span>
                    </div>
                  )}
                </div>
                ...
                <Alert className="bg-blue-950/50 border-blue-900/50 text-blue-300">
                  ...
                  <AlertDescription className="text-blue-400">
                    برای ایجاد استخر نقدینگی، نیاز به تایید مصرف توکن IRT خواهید داشت.
                  </AlertDescription>
                </Alert>
              </div>
